...
{
    public class SearchInParameters
    {
        public SearchInParameters()
        {
            IsBarcode = false;
            IsForm = true;
            IsStatus = true;
    ...
    {
        public static SearchInParameters ExceptStatus(this SearchInParameters searchParameters)
        {
            SearchInParameters parameters = new()
            {
                IsStatus = false,
